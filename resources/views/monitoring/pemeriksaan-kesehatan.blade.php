            ...
            <div class="flex flex-wrap items-center justify-between gap-4 mb-4">
                ...
                <div class="flex items-center gap-2">
                    @foreach ($distribusi as $row)
                        <span class="badge {{ $row->status->value === 'Hadir' ? 'badge-green' : 'badge-orange' }}">
                ...
                <table class="w-full">
                    <thead>
                        <tr class="border-b border-line bg-canvas-parchment/70">
                            ...
                            <th class="table-th">Kehadiran</th>
        ...
        <div class="card card-padding h-fit">
            ...
            <div class="mb-4">
                <div class="flex items-end justify-between mb-2">
                    <span class="text-sm text-muted">Kehadiran</span>
            ...
            <dl class="space-y-3 border-t border-line pt-4">
                <div class="flex justify-between">
                    <dt class="text-sm text-muted">Hadir</dt>
                    <dd class="text-sm font-semibold text-ink">{{ $hadir }} WBP</dd>
                </div>
                <div class="flex justify-between">
                    <dt class="text-sm text-muted">Belum Hadir</dt>
                    <dd class="text-sm font-semibold text-ink">{{ $total - $hadir }} WBP</dd>
                </div>
                <div class="flex justify-between">
