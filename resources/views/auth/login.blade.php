    ...
    <div class="min-h-screen flex bg-surface">
        ...
        <div class="hidden lg:flex flex-1 bg-surface-tile-1 relative items-center justify-center overflow-hidden">
            ...
            <div class="relative max-w-sm text-center px-8">
                ...
                <p class="mt-4 text-sm text-white/60 leading-relaxed">Pencatatan digital layanan hak warga binaan — kunjungan, perawatan diri, pemeriksaan kesehatan, hingga layanan laundry — dalam satu sistem.</p>
            </div>
        </div>
    </div>
</x-guest-layout>
